...
class DatabricksClient extends BaseClient {
  ...
  async buildMessages(messages, parentMessageId) {
    ...
    if (this.options.debug) {
      console.debug('DatabricksClient: orderedMessages', orderedMessages, parentMessageId);
    }
  ...
  getCompletion() {
    console.log('DatabricksClient doesn\'t use getCompletion (all handled in sendCompletion)');
  }
  ...
  getBuildMessagesOptions() {
    if (this.options.debug) {
      console.log('DatabricksClient doesn\'t use getBuildMessagesOptions');
    }
  }
